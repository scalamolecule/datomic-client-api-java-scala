...
class AsyncDbTest extends SpecAsync with AnomalyWrapper {
  ...
  "history" in new AsyncSetup {
    ...
    if (isDevLocal) {
      ...
      val retractedEid = tx.txData.iterator().asScala.toList.last.e
      waitFor(conn.transact(list(list(read(":db/retractEntity"), retractedEid.asInstanceOf[Object]))))
      films(conn.db) == threeFilms
      films(conn.db.history) == fourFilms
  ...
  "datoms" >> {
    ...
    "datoms AVET" in new AsyncSetup {
      ...
      )).toOption.get.iterator().asScala.toList === List(
      ...
      waitFor(conn.db.datoms(
        ":avet",
        list(read(":movie/title"), "Commando", e2.asInstanceOf[Object])
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      waitFor(conn.db.datoms(
        ":avet",
        list(read(":movie/title"), "Commando", e2.asInstanceOf[Object], tAfter.asInstanceOf[Object])
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      if (system == "dev-local") {
        ...
        )).toOption.get.iterator().asScala.toList.size === 243
      }
    ...
    "datoms EAVT" in new AsyncSetup {
      ...
      waitFor(conn.db.datoms(
        ":eavt",
        list(e2.asInstanceOf[Object], read(":movie/title"))
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      waitFor(conn.db.datoms(
        ":eavt",
        list(e2.asInstanceOf[Object], read(":movie/title"), "Commando")
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      waitFor(conn.db.datoms(
        ":eavt",
        list(e2.asInstanceOf[Object], read(":movie/title"), "Commando", txAfter.asInstanceOf[Object])
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
    }
    ...
    "datoms AEVT" in new AsyncSetup {
      ...
      waitFor(conn.db.datoms(
        ":aevt",
        list(read(":movie/title"), e2.asInstanceOf[Object])
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      waitFor(conn.db.datoms(
        ":aevt",
        list(read(":movie/title"), e2.asInstanceOf[Object], "Commando")
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
      ...
      waitFor(conn.db.datoms(
        ":aevt",
        list(read(":movie/title"), e2.asInstanceOf[Object], "Commando", txAfter.asInstanceOf[Object])
      )).toOption.get.iterator().asScala.toList === List(
        Datom(e2, a1, "Commando", txAfter, true)
      )
    }
  ...
  )).toOption.get.iterator().asScala.toList.map(_.v.toString)
  ...
  "indexRange" in new AsyncSetup {
    ...
    waitFor(conn.db.indexRange(":movie/title")).toOption.get.iterator().asScala.toList.sortBy(_.e) === List(
      Datom(e1, a1, "The Goonies", txAfter, true),
      Datom(e2, a1, "Commando", txAfter, true),
      Datom(e3, a1, "Repo Man", txAfter, true),
    )
    ...
    waitFor(conn.db.indexRange(":movie/title", limit = -1)).toOption.get.iterator().asScala.toList.sortBy(_.e) === List(
      Datom(e1, a1, "The Goonies", txAfter, true),
      Datom(e2, a1, "Commando", txAfter, true),
      Datom(e3, a1, "Repo Man", txAfter, true),
    )
  ...
  "indexPull" in new AsyncSetup {
    ...
    val result: List[Any] = javaStream.iterator().asScala.toList
    result.size === 2
    val firstFilm = result.head
